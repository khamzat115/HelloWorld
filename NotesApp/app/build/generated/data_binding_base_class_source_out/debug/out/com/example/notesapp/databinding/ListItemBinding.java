...
public final class ListItemBinding implements ViewBinding {
  ...
  private ListItemBinding(@NonNull CardView rootView, @NonNull TextView dateTv,
      @NonNull TextView noteTv, @NonNull TextView titleTv) {
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemBinding((CardView) rootView, dateTv, noteTv, titleTv);
    }
